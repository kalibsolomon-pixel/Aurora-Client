...
public class ModuleManager {
    ...
    private ModuleManager() {
        ...
        modules.add(new Module("miscellaneous", "Miscellaneous", "A temporary home for smaller settings without a dedicated screen of their own yet — smooth camera, frame pacing, latency, tick sync, input handling, server-list dragging, compliance and accessibility."));
    }
